...
export function MyComputer({ windowId }: MyComputerProps) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[var(--win95-bg)] text-black">
      {/* Menu Bar */}
      <div className="flex border-b border-[var(--win95-border-darker)] bg-[var(--win95-bg)] text-xs">
        <div
      ...
      {/* Status bar */}
      <div className="border-t border-[var(--win95-border-lighter)] bg-[var(--win95-bg)] p-1 text-xs flex justify-between">
        <div>
          {selectedItem
